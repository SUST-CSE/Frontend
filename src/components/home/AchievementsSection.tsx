    ...
    <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: '#f8fafc' }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 8 }}>
          <Typography variant="h3" sx={{ fontWeight: 900, color: '#0f172a', letterSpacing: '-0.02em', fontSize: { xs: '2rem', sm: '2.5rem', md: '3rem' } }}>
            Latest <span style={{ color: '#eab308' }}>Achievements</span>
          </Typography>
        </Box>
